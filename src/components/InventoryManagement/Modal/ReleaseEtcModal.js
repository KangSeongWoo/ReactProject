...
const ReleaseEtcModal = props => {
    ...
    const columnDefs = () => {
        return [
            ...
            { field: 'effStaDt', headerName: '입고일자', editable: false, suppressMenu: true },
    ...
    // 조건에 따라 내역 조회
    const checkTheValue = () => {
        const { purchaseVendorId, assortId, assortNm, storageId,channelGoodsNo } = backData
...
export default withRouter(ReleaseEtcModal)
