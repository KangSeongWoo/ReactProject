...
const Create = props => {
    ...
    const productListColumns = [
        ...
        { title: '체널매입처', dataIndex: 'buyWhere', key: 'buyWhere' },
        {
            title: '이미지',
            dataIndex: 'imagePath',
            key: 'imagePath',
    ...
    const savePurchase = e => {
        ...
        let purchase = {
            ...
            purchaseDt: Common.trim(moment().format('YYYY-MM-DD HH:mm:ss')),
            purchaseStatus: '01',
            items: items,
            dealtypeCd: '01',
    ...
    const rowSelection1 = {
        ...
        onChange: (selectedRowKeys, selectedRows) => {
            ...
            setState({
                ...state,
                vendorId: selectedRows[0].purchaseVendorId,
                purchaseVendorNm : selectedRows[0].purchaseVendorName
            })
