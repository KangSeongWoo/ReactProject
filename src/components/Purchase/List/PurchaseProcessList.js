...
const LinkCellRenderer = props => {
    return (
        <a onClick={() => {
            ...
            window
                .open(
                    '/#/purchase/processOne?' + queryStirng.stringify(props.data),
                    '상세' + new Date(),
...
const PurchaseProcessList = props => {
    const { userId } = props
    ...
    return (
        <Layout>
            <div className='notice-header'>
                <CustomBreadcrumb arr={['발주', '발주진행리스트']}></CustomBreadcrumb>
            </div>
...
export default withRouter(PurchaseProcessList)
